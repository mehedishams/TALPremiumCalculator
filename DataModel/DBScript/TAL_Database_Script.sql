...
/****** Object:  Database [TAL]    Script Date: 14/11/2021 09:09:40 PM ******/
CREATE DATABASE [TAL]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'TAL', FILENAME = N'C:\Users\mehedr01\TAL.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'TAL_log', FILENAME = N'C:\Users\mehedr01\TAL_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
...
ALTER DATABASE [TAL] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
